...
PARM_DICT ParmDict[] = {
    ...
    {PARM_TPCCALDATA2G_RAND, {(A_UINT32)PARM_TPCCALDATA2G_BINDATA}, 6, DATATYPE(PARM_DATA_256, TYPE_DATA)},
    {PARM_TPCCALDATA2GOFFSET_RAND, {(A_UINT32)10}, 17, DATATYPE(PARM_U16, TYPE_SINGULAR)},
    {PARM_TPCCALDATA5G_RAND, {(A_UINT32)PARM_TPCCALDATA5G_BINDATA}, 27, DATATYPE(PARM_DATA_512, TYPE_DATA)},
    ...
    {PARM_TPCCALDATA2G_CLPC_RAND, {(A_UINT32)PARM_TPCCALDATA2G_BINDATA}, 33, DATATYPE(PARM_DATA_256, TYPE_DATA)},
    {PARM_TPCCALDATA2GOFFSET_CLPC_RAND, {(A_UINT32)40}, 10, DATATYPE(PARM_U16, TYPE_SINGULAR)},
    {PARM_TPCCALDATA5G_CLPC_RAND, {(A_UINT32)PARM_TPCCALDATA5G_BINDATA}, 0, DATATYPE(PARM_DATA_512, TYPE_DATA)},
