                    ...
                    periodic_chan_stats_t *nstats)
{
    ...
    IEEE80211_DPRINTF_IC(ic, IEEE80211_VERBOSE_NORMAL, IEEE80211_MSG_EXTIOCTL_CHANSWITCH,
            ...
            "p_tx: %u, n_tx: %u, p_mybss_rx: %u, n_mybss_rx: %u, p_rx: %u, n_rx: %u, obss: %u, self: %u, ap_rx_cu=%u, ap_tx_cu=%u, total_cu=%u\n",
             ...
             nstats->my_bss_rx_cycle_count, pstats->rx_frame_count, nstats->rx_frame_count, rx_obss_cu, self_util, ap_rx_cu, ap_tx_cu, total_cu);
                ...
                enum htt_rx_status status)
{
    ...
    case HTT_RX_IND_MPDU_STATUS_OK:
        if (peer) {
            ...
            ppdu_start = txrx_pdev->htt_pdev->ar_rx_ops->get_ppdu_start_word(rx_desc);
            ppdu = &ppdu_start;
