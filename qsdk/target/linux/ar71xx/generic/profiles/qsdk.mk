...
STORAGE:=kmod-fs-ext4 kmod-usb-storage kmod-usb2 kmod-fs-msdos kmod-fs-ntfs \
	kmod-fs-vfat kmod-nls-cp437 kmod-nls-iso8859-1 kmod-nls-utf8
...
define Profile/QSDK_COMLLI_Router
	NAME:=Qualcomm-Atheros SDK Premium Beeliner Router Profile(COMLLI)
	PACKAGES:=luci uhttpd kmod-ipt-nathelper-extra kmod-ipt-nathelper-rtsp \
	  kmod-ipv6 ip6tables -dnsmasq dnsmasq-dhcpv6 radvd wide-dhcpv6-client \
	  -kmod-ath9k -kmod-ath5k -kmod-ath -wpad-mini kmod-qca-ssdk-hnat qca-ssdk-shell \
	  kmod-fast-classifier $(STORAGE) $(PACKAGES_WIFI) \
	  qca-legacy-uboot-ap135 qca-legacy-uboot-ap152-16M \
	  qca-legacy-uboot-ap147-16M qca-legacy-uboot-ap151-16M
endef

define Profile/QSDK_COMLLI_Router/Description
  QSDK Premium Router package set configuration.
  This profile is designed to fit in a 16M flash and supports the following features:
  - Bridging and routing networking
  - QCA-WiFi driver configuration
  ...
  - IPv4/IPv6
endef
$(eval $(call Profile,QSDK_COMLLI_Router))
